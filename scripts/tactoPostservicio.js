document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('tactoPostservicioForm');
    ...
    function guardarEnLocalStorage() {
        ...
        localStorage.setItem('registrosTactoPostservicio', JSON.stringify(registros));
    }

    // Cargar registros desde localStorage
    function cargarTabla() {
        const registros = JSON.parse(localStorage.getItem('registrosTactoPostservicio')) || [];
    ...
    guardarTablaBtn.addEventListener('click', function() {
        ...
        const nombreArchivo = `tactoPostservicio${ahora.getFullYear()}-${(ahora.getMonth()+1).toString().padStart(2, '0')}-${ahora.getDate().toString().padStart(2, '0')}_${ahora.getHours().toString().padStart(2, '0')}-${ahora.getMinutes().toString().padStart(2, '0')}-${ahora.getSeconds().toString().padStart(2, '0')}.csv`;
